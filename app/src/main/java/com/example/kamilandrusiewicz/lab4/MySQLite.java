package com.example.kamilandrusiewicz.lab4;
...
public class MySQLite extends SQLiteOpenHelper {
    ...
    public Animal pobierz(int id){
        ...
        Cursor cursor=db.query("animlas",new String[]{"_id","gatunek","kolor","wielkosc","opis"},"_id=?",new String[]{String.valueOf(id)},null,null,null,null);
        if(cursor!=null)
            cursor.moveToFirst();
